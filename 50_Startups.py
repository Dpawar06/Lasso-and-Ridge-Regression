# -*- coding: utf-8 -*-
"""
Created on Thu Sep 10 22:13:56 2020
...
# ==================================================================================================================
# Business Problem - Performing the Lasso, Ridge and ElasticNet Regression on 50_startups dataset to predict profit.
# ==================================================================================================================

# loading the data
startups = pd.read_csv("H:\DATA SCIENCE\Modules\Complet  Assignment\Module 8 lasso Ridge regression\Assig- 8 Lasso & RIdge Regression\\50_Startups.csv")

# to get top 6 rows
startups.head(6) # to get top n rows use cars.head(10)
...
# Basic EDA
plt.scatter(x=startups.RandD,y=startups.profit)
plt.scatter(x=startups.RandD,y=startups.profit,c="b");plt.xlabel("RandD");plt.ylabel("profit")
plt.hist(startups.RandD) # complete right skewed 
plt.hist(startups.profit) # close to normal distribution
...
pd.plotting.scatter_matrix(startups) #; -> also used for plotting all in one graph
